...
// gebeurt in /api/analytics/hit (Node-runtime). We sluiten ingelogde
// beheerders best-effort uit: als het sessiecookie er is, tellen we niet mee.
// Dat is geen waterdichte rolcheck (die kost Node-crypto), maar voor een
// lichte statistiek is "cookie aanwezig -> waarschijnlijk beheerder" precies
// genoeg.
export function middleware(request: NextRequest) {
  ...
  if (isPubliekePagina && !isAdminSessie) {
